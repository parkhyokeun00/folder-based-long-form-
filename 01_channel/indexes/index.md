...
This is the catalog for the live long-form engine.

## Core

- [channel-core.md](../channel-core.md): highest-level channel promise, viewer model, permanent craft rules
...
- [episode-network.md](../network/episode-network.md): backward callbacks, sequel seeds, topic lane bridges, reusable adjacency map

## Chronology

- [log.md](log.md): append-only engine timeline of promotions, audits, and major structural updates
